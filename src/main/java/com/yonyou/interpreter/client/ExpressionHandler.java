package com.yonyou.interpreter.client;

import com.yonyou.interpreter.common.expression.IExpression;
 ...
 *
 * @author hlz
 * @date 2020年 10月14日 14:12:23
 */
public class ExpressionHandler {

    public static void main(String[] args) {
        String test = "ACAACCCCAC";
        int aabbbb = kmp(test.toCharArray(), 5,-1,null,"A");
        System.out.println(aabbbb);
    }

    public static IExpression initExpression(String exp) {
     ...
     * @return pmt
     */
    private static int[] pmt(String regex) {
